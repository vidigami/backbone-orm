...
module.exports = (options) ->
  ...
  # HasOne/BelongsTo
  #############################
  results.push class OFlat extends Backbone.Model
    model_name: 'Flat'
  ...
  results.push class OReverse extends Backbone.Model
    model_name: 'Reverse'
  ...
  results.push class M2MReverse extends Backbone.Model
    model_name: 'Reverse'
  ...
  results.push class M2MOwner extends Backbone.Model
    model_name: 'Owner'
