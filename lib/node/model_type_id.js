  ...
  ModelTypeID.prototype.generate = function(model_type) {
    ...
    if (!(id = model_type.model_type_id)) {
      ...
      if (this.enabled && this.ids[id] && this.ids[id] !== model_type) {
        throw new Error("Duplicate model name / url combination: " + model_type.model_name + ", " + (_.result(model_type.prototype.prototype, 'url')) + ". Set a unique model_name property on one of the conflicting models.");
      }
    }
