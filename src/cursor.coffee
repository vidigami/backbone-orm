...
module.exports = class Cursor
  ...
  toModels: (callback) ->
    return callback(new Error "Cannot call toModels on cursor with values for model #{@model_type.model_name}. Values: #{Utils.toString(@_cursor.$values)}") if @_cursor.$values
